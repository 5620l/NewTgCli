...
pm = pm..'\n➖➖➖➖➖➖➖➖➖➖'
pm = pm..'\n⚡️<i>Lock Links : '..(group[tostring(target)]['settings']['lock_link'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Username : '..(group[tostring(target)]['settings']['lock_username'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Edit : '..(group[tostring(target)]['settings']['lock_edit'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Location : '..(group[tostring(target)]['settings']['lock_location'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Caption : '..(group[tostring(target)]['settings']['lock_caption'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Inline : '..(group[tostring(target)]['settings']['lock_inline'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Reply : '..(group[tostring(target)]['settings']['lock_reply'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Fwd : '..(group[tostring(target)]['settings']['lock_fwd'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Spam : '..(group[tostring(target)]['settings']['lock_spam'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock English : '..(group[tostring(target)]['settings']['lock_english'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Persian : '..(group[tostring(target)]['settings']['lock_persian'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock TGservice : '..(group[tostring(target)]['settings']['lock_tgservice'] or 'no')..'</i>'
pm = pm..'\n⚡️<i>Lock Sticker : '..(group[tostring(target)]['settings']['lock_sticker'] or 'no')..'</i>'
pm = pm..'\n➖➖➖➖➖➖➖➖➖➖'
pm = pm..'\n⚙<b>Mutelist :</b>⚙'
pm = pm..'\n➖➖➖➖➖➖➖➖➖➖'
...
pm = '⚙<b>SuperGroup Settings :</b>⚙'
pm = pm..'\n➖➖➖➖➖➖➖➖➖➖'
pm = pm..'\n⚡️<i>Lock Links : '..group[tostring(target)]['settings']['lock_link']..'</i>'
pm = pm..'\n⚡️<i>Lock Username : '..group[tostring(target)]['settings']['lock_username']..'</i>'
pm = pm..'\n⚡️<i>Lock Edit : '..group[tostring(target)]['settings']['lock_edit']..'</i>'
pm = pm..'\n⚡️<i>Lock Location : '..group[tostring(target)]['settings']['lock_location']..'</i>'
pm = pm..'\n⚡️<i>Lock Caption : '..group[tostring(target)]['settings']['lock_caption']..'</i>'
pm = pm..'\n⚡️<i>Lock Inline : '..group[tostring(target)]['settings']['lock_inline']..'</i>'
pm = pm..'\n⚡️<i>Lock Reply : '..group[tostring(target)]['settings']['lock_reply']..'</i>'
pm = pm..'\n⚡️<i>Lock Fwd : '..group[tostring(target)]['settings']['lock_fwd']..'</i>'
pm = pm..'\n⚡️<i>Lock Spam : '..group[tostring(target)]['settings']['lock_spam']..'</i>'
pm = pm..'\n⚡️<i>Lock English : '..group[tostring(target)]['settings']['lock_english']..'</i>'
pm = pm..'\n⚡️<i>Lock Persian : '..group[tostring(target)]['settings']['lock_persian']..'</i>'
pm = pm..'\n⚡️<i>Lock TGservice : '..group[tostring(target)]['settings']['lock_tgservice']..'</i>'
pm = pm..'\n⚡️<i>Lock Sticker : '..group[tostring(target)]['settings']['lock_sticker']..'</i>'
pm = pm..'\n➖➖➖➖➖➖➖➖➖➖'
pm = pm..'\n⚙<b>Mutelist :</b>⚙'
pm = pm..'\n➖➖➖➖➖➖➖➖➖➖'
